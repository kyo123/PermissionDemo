 ...
 */
public class PermissionUtilsTemp {

    private static final String TAG = PermissionUtilsTemp.class.getSimpleName();
    /**
...
//        }
        ...
        if (checkSelfPermission != PackageManager.PERMISSION_GRANTED) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(activity, requestPermission)) {
                ...
                showShowRationale(activity, requestCode, requestPermission);
...
//        }
    ...
    private static void showShowRationale(final Activity activity, final int requestCode, final String requestPermission) {
        //TODO
